...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/newallmoviesx"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/newallmoviesx'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/newallmoviesx')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/newallmoviesx')
            ]
            ]
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/newallmoviesxe')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/newallmoviesx')
            ]https://t.me/newallmoviesx
            ]
        await query.answer()
        await client.send_cached_media(
            chat_id=query.from_user.id,
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/newallmoviesx'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/newallmoviesx')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/newallmoviesx'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/newallmoviesx")
    ])
